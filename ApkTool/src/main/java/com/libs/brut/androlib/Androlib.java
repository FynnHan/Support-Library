...
import com.libs.brut.androlib.res.data.ResUnknownFiles;
import com.libs.brut.androlib.res.util.ExtFile;
import com.libs.brut.androlib.res.xml.ResXmlPatcher;
import com.libs.brut.androlib.src.SmaliBuilder;
import com.libs.brut.androlib.src.SmaliDecoder;
...
public class Androlib {
    ...
    public void decodeSourcesSmali(File apkFile, File outDir, String filename, boolean bakdeb, int api) throws AndrolibException {
        try {
            ...
            SmaliDecoder.decode(apkFile, smaliDir, filename, bakdeb, api);// 解析出smali
